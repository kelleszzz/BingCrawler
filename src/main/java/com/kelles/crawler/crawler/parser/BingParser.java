...
import com.kelles.crawler.crawler.analysis.*;
import com.kelles.crawler.crawler.database.*;
import com.kelles.crawler.crawler.download.*;
...
public class BingParser extends AbstractParser {
    ...
    protected void setup() {
        super.setup();
        Logger.log("[初始化]Initializing ProfilesManager");
